...
```
FDR corrected p-values = `r round(p.adjust(c(0.0021530,0.0004615,0.2541364), method = 'fdr'),digits=3)`
```{r FDR corrected p-values, warning=FALSE, message=FALSE, results='hide'}
...
```
FDR corrected p-values = `r round(p.adjust(c(2.432e-09, 1.084e-06,0.1754), method = 'fdr'),digits=3)`
```{r FDR corrected p-values in females, warning=FALSE, message=FALSE, results='hide'}
