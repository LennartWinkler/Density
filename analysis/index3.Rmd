...
p3<-ggplot(D_data, aes(x=Sex, y=as.numeric(Total_Encounters),fill=TreatCgroup, col=TreatCgroup,alpha=TreatCgroup)) +
  ...
  stat_summary(fun = mean,
               position=position_dodge2(0.3), size = 1,col=c("#b2182b","#b2182b","#2166AC","#2166AC"),alpha=c(1,1,1,1),show.legend = F, stroke = 0,linewidth = 1.2)+
  stat_summary(fun.min =lower_SD ,
               fun.max = upper_SD ,fun = mean,
  ...
  xlab('Sex')+ylab("Copulation encounters")+ggtitle('')+ theme(plot.title = element_text(hjust = 0.5))+
  ...
  annotate("text",label='46',x=1.23,y=30,size=4)+
  annotate("text",label='45',x=1.78,y=30,size=4)+
...
p3.2<-ggplot(D_data, aes(x=Sex, y=as.numeric(Total_Encounters),fill=TreatCarena, col=TreatCarena,alpha=TreatCarena)) +
  ...
  stat_summary(fun.min =lower_SD ,
               fun.max = upper_SD ,fun = mean,
               position=position_dodge2(0.3),col=c("#b2182b","#b2182b","#2166AC","#2166AC"),alpha=c(0.5,0.75,0.5,0.75),show.legend = F, linewidth = 1.15)+scale_color_manual(values=c(colpal2[1],colpal2[1],colpal2[2],colpal2[2]),name = "Treatment", labels = c('Females: Large arena','Females: Small arena','Males: Large arena','Males: Small arena'))+
  ...
  annotate("text",label='55',x=1.23,y=30,size=4)+
  annotate("text",label='48',x=1.78,y=30,size=4)+
  annotate("text",label='49',x=2.23,y=30,size=4)+
  guides(colour = guide_legend(override.aes = list(size=4)))+
  fig_theme

### Plot: Copulations per encounter ####
p4<-ggplot(D_data, aes(x=Sex, y=as.numeric(Prop_MS),fill=TreatCgroup, col=TreatCgroup,alpha=TreatCgroup)) +
  ...
  stat_summary(fun.min =lower_SD ,
               fun.max = upper_SD ,fun = mean,
               position=position_dodge2(0.3),col=c("#b2182b","#b2182b","#2166AC","#2166AC"),alpha=c(0.5,0.75,0.5,0.75),show.legend = F, linewidth = 1.15)+scale_color_manual(values=c(colpal2[1],colpal2[1],colpal2[2],colpal2[2]),name = "Treatment", labels = c('Females: Small group','Females: Large group','Males: Small group','Males: Large group'))+
  scale_fill_manual(values=c(colpal2[1],colpal2[1],colpal2[2],colpal2[2]),name = "Treatment", labels = c('Females: Small group','Females: Large group','Males: Small group','Males: Large group'))+
  scale_alpha_manual(values=c(0.5,0.75,0.5,0.75),name = "Treatment", labels = c('Females: Small group','Females: Large group','Males: Small group','Males: Large group'))+
  xlab('')+ylab("Copulations per encounter")+ggtitle('')+ theme(plot.title = element_text(hjust = 0.5))+
  ...
  annotate("text",label='46',x=1.23,y=1.1,size=4)+
  annotate("text",label='45',x=1.78,y=1.1,size=4)+
...
p4.2<-ggplot(D_data, aes(x=Sex, y=as.numeric(Prop_MS),fill=TreatCarena, col=TreatCarena,alpha=TreatCarena)) +
  ...
  annotate("text",label='55',x=1.23,y=1.1,size=4)+
  annotate("text",label='48',x=1.78,y=1.1,size=4)+
...
p5<-ggplot(D_data, aes(x=Sex, y=as.numeric(MatingPartners_number),fill=TreatCgroup, col=TreatCgroup,alpha=TreatCgroup)) +
  ...
  annotate("text",label='46',x=1.23,y=5.4,size=4)+
  annotate("text",label='45',x=1.78,y=5.4,size=4)+
...
p5.2<-ggplot(D_data, aes(x=Sex, y=as.numeric(MatingPartners_number),fill=TreatCarena, col=TreatCarena,alpha=TreatCarena)) +
  ...
  annotate("text",label='55',x=1.23,y=5.4,size=4)+
  annotate("text",label='48',x=1.78,y=5.4,size=4)+
...
p6<-ggplot(D_data, aes(x=Sex, y=as.numeric(Matings_number),fill=TreatCgroup, col=TreatCgroup,alpha=TreatCgroup)) +
  ...
  annotate("text",label='46',x=1.23,y=12,size=4)+
  annotate("text",label='45',x=1.78,y=12,size=4)+
...
p6.2<-ggplot(D_data, aes(x=Sex, y=as.numeric(Matings_number),fill=TreatCarena, col=TreatCarena,alpha=TreatCarena)) +
  ...
  annotate("text",label='55',x=1.23,y=12,size=4)+
  annotate("text",label='48',x=1.78,y=12,size=4)+
...
p7<-ggplot(D_data, aes(x=Sex, y=as.numeric(meanCop),fill=TreatCgroup, col=TreatCgroup,alpha=TreatCgroup)) +
  ...
  annotate("text",label='49',x=0.78,y=4.5,size=4)+
  annotate("text",label='43',x=1.23,y=4.5,size=4)+
  annotate("text",label='34',x=1.78,y=4.5,size=4)+
  annotate("text",label='51',x=2.23,y=4.5,size=4)+
  guides(colour = guide_legend(override.aes = list(size=4)))+
  fig_theme
...
p7.2<-ggplot(D_data, aes(x=Sex, y=as.numeric(meanCop),fill=TreatCarena, col=TreatCarena,alpha=TreatCarena)) +
  ...
  annotate("text",label='n =',x=0.55,y=4.5,size=4)+
  annotate("text",label='46',x=0.78,y=4.5,size=4)+
  annotate("text",label='49',x=1.23,y=4.5,size=4)+
  annotate("text",label='37',x=1.78,y=4.5,size=4)+
  annotate("text",label='45',x=2.23,y=4.5,size=4)+
  guides(colour = guide_legend(override.aes = list(size=4)))+
  fig_theme
...
p8<-ggplot(D_data, aes(x=Sex, y=as.numeric(MatingDuration_av),fill=TreatCgroup, col=TreatCgroup,alpha=TreatCgroup)) +
  ...
  annotate("text",label='43',x=1.23,y=390,size=4)+
  annotate("text",label='34',x=1.78,y=390,size=4)+
...
p8.2<-ggplot(D_data, aes(x=Sex, y=as.numeric(MatingDuration_av),fill=TreatCarena, col=TreatCarena,alpha=TreatCarena)) +
  ...
  annotate("text",label='49',x=1.23,y=390,size=4)+
  annotate("text",label='37',x=1.78,y=390,size=4)+
...
p9<-ggplot(D_data, aes(x=Sex, y=as.numeric(Total_N_MTP1),fill=TreatCgroup, col=TreatCgroup,alpha=TreatCgroup)) +
  ...
  annotate("text",label='46',x=1.23,y=320,size=4)+
  annotate("text",label='45',x=1.78,y=320,size=4)+
...
p9.2<-ggplot(D_data, aes(x=Sex, y=as.numeric(Total_N_MTP1),fill=TreatCarena, col=TreatCarena,alpha=TreatCarena)) +
  ...
  annotate("text",label='55',x=1.23,y=320,size=4)+
  annotate("text",label='48',x=1.78,y=320,size=4)+
...
### Figure S2
```{r , warning=FALSE, message=FALSE, fig.align="center",fig.width = 9, results='hide',fig.cap='Figure S2: Mating behavior of males and females under low and high density manipulation via group (left) and arena size (right). Grey bars indicate means and standard deviations.',fig.height=15}
#Behaviour 1 (Figure S2)
Figure_S2<-grid.arrange(p3+labs(tag = "A")+xlab('')+theme(plot.margin = unit(c(0.2,3.5,0,0.1), "cm")),p3.2+labs(tag = "B")+xlab('')+theme(plot.margin = unit(c(0.2,3.5,0,0.1), "cm")),
                        ...
                        ,nrow = 3,ncol=2)
Fig_S2=plot_grid(Figure_S2, ncol=1, rel_heights=c(0.1, 1)) # rel_heights values control title margins
```

### Figure S3
```{r , warning=FALSE, message=FALSE, fig.align="center",fig.width = 9, results='hide',fig.cap='Figure S3: Mating behavior of males and females under low and high density manipulation via group (left) and arena size (right). Grey bars indicate means and standard deviations.',fig.height=15}
#Behavior 2 (Figure S3)
Figure_S3<-grid.arrange(p6+labs(tag = "A")+xlab('')+theme(plot.margin = unit(c(0.2,3.5,0,0.1), "cm")),p6.2+labs(tag = "B")+xlab('')+theme(plot.margin = unit(c(0.2,3.5,0,0.1), "cm")),
...
Fig_S3=plot_grid(Figure_S3, ncol=1, rel_heights=c(0.1, 1)) # rel_heights values control title margins
```

### Figure S4
```{r , warning=FALSE, message=FALSE, fig.align="center",fig.width = 10, results='hide',fig.cap='Figure S4: Reproductive success of males and females under density manipulation via group (left) and arena size (right). Grey bars indicate means and standard deviations.'}
# Reproductive success (Figure S4)
Figure_S4<-grid.arrange(grobs = list(p9+theme(plot.margin = unit(c(0.2,4,0,0.1), "cm")),p9.2+theme(plot.margin = unit(c(0.2,4,0,0.1), "cm"))), nrow = 1,ncol=2, widths=c(2.3, 2.3))
Fig_S4=plot_grid(Figure_S4, ncol=1, rel_heights=c(0.1, 1)) # rel_heights values control title margins
```
...
### Figure S5
```{r , warning=FALSE, message=FALSE, fig.align="center",fig.width = 10, results='hide',fig.cap='Figure S5: Coefficients of variation (CV) in mating behavior for females (blue) and males (red) under density manipulated via group (point) or arena size (square). Copulation attempts (A), proportion of successful copulations (B), number of partners (C), number of copulations (D), copulations per partners (E) and copulation duration (F) with mean and 95%CI estimated via bootstrapping (Table S2). In grey area metrics were larger under high density treatments. The x-/y-distance of means from dashed line is equal to the effect size of the treatment.',fig.height=10}
Figure_S5<-grid.arrange(p10+theme(legend.position = c(1, 0.8),legend.text = element_text(size=9)),p11+theme(legend.position = c(1, 0.8),legend.text = element_text(size=9)),p12+theme(legend.position = 'none'),p13+theme(legend.position = 'none'),p14+theme(legend.position = 'none'),p15+theme(legend.position = 'none'), nrow = 3,ncol=2)
Fig_S5=plot_grid(Figure_S5, ncol=1, rel_heights=c(0.2, 1.1)) # rel_heights values control title margins
```
