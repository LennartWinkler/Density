...
### Figure S8
Figure_S8<-grid.arrange(BarPlot_5_2+labs(tag = "A"),BarPlot_6_2+labs(tag = "B"),BarPlot_1cv+labs(tag = "C")+xlab('Variance component'),BarPlot_2cv+labs(tag = "D")+xlab('Variance component'), nrow = 2,ncol=2)
