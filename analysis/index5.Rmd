...
subtitle: Analyses excluding individuals without mating success (treatment specific)
...
PhenVarBoot_Table_Male_0.26_cov_mMS_feSuc <- as.data.frame(cbind("Male", "cov_mMS_feSuc", "0.26", mean(D0.26_M_cov_mMS_feSuc_bootvar$t), quantile(D0.26_M_cov_mMS_feSuc_bootvar$t,.025, names = FALSE), quantile(D0.26_M_cov_mMS_feSuc_bootvar$t,.975, names = FALSE)))
PhenVarBoot_Table_Male_0.26_cov_mMS_pFec <- as.data.frame(cbind("Male", "cov_mMS_pFec", "0.26", mean(D0.26_M_cov_mMS_pFec_bootvar$t), quantile(D0.26_M_cov_mMS_pFec_bootvar$t,.025, names = FALSE), quantile(D0.26_M_cov_mMS_pFec_bootvar$t,.975, names = FALSE)))

PhenVarBoot_Table_Male_0.26_cov_inSuc_feSuc <- as.data.frame(cbind("Male", "cov_inSuc_feSuc", "0.26", mean(D0.26_M_cov_inSuc_feSuc_bootvar$t), quantile(D0.26_M_cov_inSuc_feSuc_bootvar$t,.025, names = FALSE), quantile(D0.26_M_cov_inSuc_feSuc_bootvar$t,.975, names = FALSE)))
PhenVarBoot_Table_Male_0.26_cov_inSuc_pFec <- as.data.frame(cbind("Male", "cov_inSuc_pFec", "0.26", mean(D0.26_M_cov_inSuc_pFec_bootvar$t), quantile(D0.26_M_cov_inSuc_pFec_bootvar$t,.025, names = FALSE), quantile(D0.26_M_cov_inSuc_pFec_bootvar$t,.975, names = FALSE)))

PhenVarBoot_Table_Male_0.26_cov_feSuc_pFec <- as.data.frame(cbind("Male", "cov_feSuc_pFec", "0.26", mean(D0.26_M_cov_feSuc_pFec_bootvar$t), quantile(D0.26_M_cov_feSuc_pFec_bootvar$t,.025, names = FALSE), quantile(D0.26_M_cov_feSuc_pFec_bootvar$t,.975, names = FALSE)))

PhenVarBoot_Table_Female_0.26_cov_fMS_fFec <- as.data.frame(cbind("Female", "cov_fMS_fFec", "0.26", mean(D0.26_F_cov_fMS_fFec_bootvar$t), quantile(D0.26_F_cov_fMS_fFec_bootvar$t,.025, names = FALSE), quantile(D0.26_F_cov_fMS_fFec_bootvar$t,.975, names = FALSE)))
